...
storeonceUsername="mon" #Your username, if using domain based account, please add it like user@domain.com (if you use domain\account it is not going to work!)
storeoncePassword='passwd'
storeonceRestServer="https://storeonce.moskvich.ru"
